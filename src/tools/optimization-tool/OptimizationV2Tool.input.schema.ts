...
/**
 * Input schema for OptimizationV2Tool (V2 API - Beta)
 *
 * The V2 API is currently in beta and requires early access.
 * Supports advanced features: time windows, capacity limits, vehicle capabilities,
 * shipments, breaks, and more.
 */
...
export const OptimizationV2InputSchema = z.object({
  coordinates: z
...
export type OptimizationV2Input = z.infer<typeof OptimizationV2InputSchema>;
