...
- **MCP Apps Support for StaticMapImageTool** (#109)
  ...
  - Refactored tool to return map URL directly instead of base64-encoded images (better performance, no server-side fetching)
  ...
  - Maintains backward compatibility with existing MCP-UI support
